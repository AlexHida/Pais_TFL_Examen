...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btn_captura:Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_captura = findViewById(R.id.masinfo) as Button

        btn_captura.setOnClickListener {

            //Toast.makeText(this,countryCode, Toast.LENGTH_LONG).show()
            val intent = Intent(this, capturaPais::class.java).apply {
    ...
    private class ImageAnalyzer(ctx: Context, private val listener: RecognitionListener) :
        ...
        // method is called.
        private val modelBand = Model.newInstance(ctx)
        private lateinit var listerModel:DatosListener
        ...
        override fun analyze(imageProxy: ImageProxy) {
            ...
            val outputs = modelBand.process(tfImage).probabilityAsCategoryList.apply {
            ...
            listerModel.setOnDatosListerner(outputs[0].label)
